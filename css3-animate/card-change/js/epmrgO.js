...
(function() {
        ...
        b.onclick = function() {
            if (ga) {
                ...
                ga("send", "event", "shawhead", "click", a, {
                    transport: "beacon",
