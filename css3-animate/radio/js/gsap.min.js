...
!function (t, e) {
    ...
    var F, R, i, n, a, h, l, f, d, c, m, g, y, b, T, w, x, k, A, C, S, D, z, I, E, B,
    ...
    var Yt, Xt = function _addPropTween(t, e, r, i, n, a, s, u, h) {
            ...
            var i, n, a, s, o, u, h, l, f, d, c, p, m, g = e.vars, v = g.ease, y = g.startAt, b = g.immediateRender,
                ...
                M = g.keyframes, A = g.autoRevert, C = e._dur, S = e._startAt, D = e._targets, z = e.parent,
            ...
            if (!B || M && v || (v = "none"), e._ease = Ft(v, L.ease), e._yEase = k ? Bt(Ft(!0 === k ? v : k, L.ease)) : 0, k && e._yoyo && !e._repeat && (k = e._yEase, e._yEase = e._ease, e._ease = k), e._from = !B && !!g.runBackwards, !B) {
                if (p = (l = D[0] ? _(D[0]).harness : 0) && g[l.prop], i = ma(g, ut), S && S.render(-1, !0).kill(), y) if (ra(e._startAt = Qt.set(D, ia({
                    data: "isStart",
                    overwrite: !1,
                    parent: z,
                    immediateRender: !0,
                ...
                } else !1 === A && (e._startAt = 0); else if (P && C) if (S) A || (e._startAt = 0); else if (r && (b = !1), a = ia({
                    overwrite: !1,
                    data: "isFromStart",
                    lazy: b && t(T),
                    immediateRender: b,
        ...
        Wt = (jt + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), Qt = function (C) {
            function Tween(e, r, i, n) {
                var a;
                "number" == typeof r && (i.duration = r, r = i, i = null);
                var o, u, h, l, f, d, c, p, _ = (a = C.call(this, n ? r : na(r)) || this).vars, m = _.duration, g = _.delay,
    ...
    ba("to,from,fromTo,delayedCall,set,killTweensOf", function (t) {
        return se[t] = Qt[t]
    }), St.add(qt.updateRoot), d = se.to({}, {duration: 0});
    ...
    var ue, he, le, fe, de, ce, pe, _e = zt.Power0, me = zt.Power1, ge = zt.Power2, ve = zt.Power3, ye = zt.Power4,
        ...
        Me = zt.Back, Ae = zt.SteppedEase, Ce = zt.Bounce, Se = zt.Sine, De = zt.Expo, ze = zt.Circ, Ie = {},
        Ee = 180 / Math.PI, Be = Math.PI / 180, Fe = Math.atan2, Re = /([A-Z])/g,
